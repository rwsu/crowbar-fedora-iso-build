...
get_barclamp_info() {
    # RWSU
    cp /home/rwsu/crowbar/fedora-18-extra/crowbar.yml /home/rwsu/crowbar/barclamps/crowbar
    cp /home/rwsu/crowbar/fedora-18-extra/provisioner-crowbar.yml /home/rwsu/crowbar/barclamps/provisioner/crowbar.yml
...
in_fedora_chroot() { sudo -H /usr/sbin/chroot "$CHROOT" /usr/bin/bash -l -c "$*"; }
...
build_iso() (
    ...
    echo "RWSU build_iso IMAGE_DIR $IMAGE_DIR"
    echo "RWSU build_iso BUILD_DIR $BUILD_DIR"
    echo "RWSU build_iso ISO_DEST $ISO_DEST"
    echo "RWSU build_iso BUILT_ISO $BUILT_ISO"
    echo "RWSU build_iso VERSION $VERSION"
    #sleep 10000
